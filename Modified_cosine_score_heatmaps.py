...
similarity_measure = ModifiedCosine(tolerance=0.005) #you're free to select another similarity score and to set the tolerance (don't forget to import the module before)
